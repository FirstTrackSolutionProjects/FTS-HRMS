...
const WhoAmI = () => {
  ...
  return (
    <Box className="flex flex-col" p={4}>
        ...
        <Box className="flex relative flex-col md:flex-row justify-center items-center space-x-0 space-y-4 md:space-x-4 md:space-y-0 text-white" py={4}>
            <Box className="group bg-gradient-to-r from-green-400 to-blue-500 flex w-full md:w-[50%] h-full justify-center items-center flex-col p-2 rounded-lg shadow-lg hover:bg-blue-300 transition-colors duration-500 cursor-pointer">
            ...
            <Box className="group bg-gradient-to-r from-blue-400 to-green-500 flex w-full md:w-[50%] h-full justify-center items-center flex-col p-2 rounded-lg shadow-lg hover:bg-blue-300 transition-colors duration-500 cursor-pointer">
                <Box className="flex flex-col items-center justify-center transition-transform duration-500 group-hover:-translate-y-3">
