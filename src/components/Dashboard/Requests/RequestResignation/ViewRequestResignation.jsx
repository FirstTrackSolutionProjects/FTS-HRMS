...
import ApplyResignationPopup from './ApplyResignationPopup'
...
import getMyResignationApplicationsService from '@/services/exitServices/resignationServices/getMyResignationApplicationsService'
const ViewRequestResignation = () => {
    ...
    const getAllBranches = async () => {
      const branches = await getMyResignationApplicationsService()
      setRows(branches)
    }
    useEffect(()=> {
      getAllBranches()
  ...
  return (
    <Box className="p-4">
      <Box sx={{
        ...
        <Box sx={{
          ...
          <CustomButton
            ...
            title="Apply"
            onClick={handleApplyResignationPopup}
          />
        </Box>
      </Box>
      <DataGrid
      ...
      />
      <ApplyResignationPopup open={applyResignationPopupOpen} onClose={handleApplyResignationPopup} onSubmit={handleApplyResignationEvent} />
    </Box>
  )
}
