...
import reviewResignationApplication from "@/services/exitServices/resignationServices/reviewResignationApplication"
const ShowRequestPopup = ({ open, onClose, applicationId }) => {
    ...
    const getResignationApplication = async () => {
        try{
            const response = await reviewResignationApplication(applicationId)
