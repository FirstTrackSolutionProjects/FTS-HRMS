...
const RevisePayrollPopup = ({ open, onClose, onSubmit, requestId }) => {
    if (!open) return;
    ...
    return (
        ...
        >
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                <EmployeePayrollStructure ref={payrollRef} onSubmit={handleSubmit} valueMap={existingPayroll} />
            </Box>
        </ActionPopup>
    )
}

export default RevisePayrollPopup
