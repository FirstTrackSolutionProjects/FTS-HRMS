...
import getCareerSubmissionService from "@/services/submissionServices/careerSubmissionServices/getCareerSubmissionService"
...
const ViewCareerSubmission = ({
    ...
    const getEmployee = async ()=>{
        try{
            const data = await getCareerSubmissionService(submissionId);
            setEmployee(data);
        } catch (err) {
    ...
    return (
        <ActionPopup open={open} onClose={onClose} title="View/Edit Employee" actions={[
            ...
            <CustomForm 
              ref={employeeFormRef} 
              fields={careerSubmissionFields} 
              setFields={setCareerSubmissionFields} 
...
export default ViewCareerSubmission