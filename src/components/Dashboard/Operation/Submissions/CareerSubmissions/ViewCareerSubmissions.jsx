...
import ViewCareerSubmission from './ViewCareerSubmission'
import getCareerSubmissionsService from '@/services/submissionServices/careerSubmissionServices/getCareerSubmissionsService'
const ViewCareerSubmissions = () => {
        ...
        renderCell: (params) => {
            ...
            return (
                <>
                    ...
                    <ViewCareerSubmission open={viewEditEmployeeDetailPopupOpen} onClose={handleViewEditEmployeeDetailPopup} onSubmit={handleViewEditEmployeeDetailEvent} submissionId={params?.id}  />
                </>
            )
        }
      },
    ...
    const getAllBranches = async () => {
      const branches = await getCareerSubmissionsService()
      setRows(branches)
    }
    useEffect(()=> {
      getAllBranches()
...
export default ViewCareerSubmissions
